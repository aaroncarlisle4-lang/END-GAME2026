# Finding: Hepatitis (DDx)

**Source section:** Hepatitis
**Quality score:** 0.6
...
- biliary obstruction (eg

## Context

often NO radiologic findings | small bile ducts diminished in number | hepatomegaly | heterogeneously enhancing parenchyma
